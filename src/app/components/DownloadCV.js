...
export default function DownloadCV() {
  return (
    <div className="flex flex-col  mt-[100px] mb-[100px] items-center py-8">
      <div class="relative duration-300  hover:-rotate-0  -rotate-12 group border border-sky-800  border-4  overflow-hidden rounded-2xl relative h-52 w-96 bg-gradient-to-r to-emerald-600 from-sky-400  p-5 flex flex-col items-start gap-4">
        <div class="text-gray-50">
          <span class="font-bold text-5xl">FullStack</span>
          <p class="text-xs"> Developer</p>
        </div>
        <a
          href="/CV-Alexander-Arvelo.pdf"
          download
          class="duration-300 hover:bg-sky-900 border rounded-3xl hover:text-gray-50 bg-gray-50 font-semibold text-sky-800 px-3 py-2 flex flex-row items-center gap-3"
        >
          Dowload CV
          <svg
