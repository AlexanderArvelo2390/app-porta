  ...
  return (
    <FadeInSection>
      <div className="relative">
        <section
          id="about"
          className="container py-12 flex flex-col md:flex-row items-center gap-10 mt-10 mb-16 relative z-20"
        >
          <div className="flex-1 flex flex-col items-start">
            ...
            <p className="text-lg text-gray-500 leading-relaxed mb-6">
              ...
              pasarelas de pago para desarrollar productos completos, eficientes
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside text-gray-800 space-y-1">
                <li className="text-gray-400">
                  ...
                  moderno (React, Next.js, Vite, Strapi, TailwindCSS), CMS
                  híbrido visual/headless y arquitectura escalable. Integración
                  de pruebas e2e (Cypress, Jest), diseño responsive y
                  autenticación privada. (2025)
                </li>
                <li className="text-gray-400">
                  <span className="font-semibold text-gray-800">
                    EventMedia – App de Depósito:
                  </span>{" "}
                  App interna en React Native para mejorar el flujo de trabajo
                  en el depósito técnico de una empresa de espectáculos. Gestión
                  de equipos, inventario y logística operativa. Aplicación
                  utilizada en producción por el equipo técnico. (2025)
                </li>
                <li className="text-gray-400">
                  <span className="font-semibold text-gray-800">
                ...
                <li className="text-gray-400">
                  ...
                  notificaciones automáticas, adaptable a distintos tipos de
                  shows y espectáculos en vivo. Integración con sistemas
                  externos de control de acceso y planificación de actividades.
                </li>
              </ul>
            </div>
            ...
            <p className="text-base text-gray-400 italic">
              ...
              positivo sean protagonistas. Me interesa formar parte de equipos
              que valoren el buen código, el diseño centrado en el usuario y el
